    ...
    render () {
        return (
            <div>
                ...
                <CounterControl label="Subtract 5" clicked={this.props.subtract5Counter}  />
                <hr />
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        add5Counter: () => dispatch(actionCreators.add(10)),
        subtract5Counter: () => dispatch(actionCreators.subtract(5)),
